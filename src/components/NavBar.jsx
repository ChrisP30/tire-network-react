...
function NavBar() {
  const ourShopArr = [
    { text: "Our Shop", link: "/tire-network-react/shop" },
    { text: "Location", link: "/tire-network-react/location" },
    { text: "Customer Service", link: "/tire-network-react/customer" },
    {
      text: "Reviews",
      link: "https://www.google.com/localservices/prolist?g2lbs=AIQllVwENXMKjBxqfoSM8trVe7jF9c4KmjOF3DkorWv9-f_X1XQEBFI1hw5xdLO-YWMY_WNn7xvw-87bHe5_b5OP4NEtMw-TqOCJEHLSpwfa1Eqa0w-BelODgvSk0kkPibx62Vi8W1aCs_q0um2k0hw3fCzBy56O7g%3D%3D&hl=en-US&gl=us&ssta=1&oq=auto%20shops%20in%20md&src=2&serdesk=1&sa=X&scp=CgASABoAKgA%3D&spp=QiUweDg5YzgwMzY4NjQ3ZGFmMzc6MHgyOTlmZjg1MmRlZjNmOGJl&slp=MgBAAVIvCAESKRInCiUweDg5YzgwMzY4NjQ3ZGFmMzc6MHgyOTlmZjg1MmRlZjNmOGJlIACaAQYKAhcZEAA%3D&q=the%20tire%20network%201024%20S%20Hanover%20St&ved=0CAAQ0swJahgKEwiQrJjUnfqDAxUAAAAAHQAAAAAQkQE#ts=1",
    },
  ];
  const servicesArr = [
    { text: "Repair Services", link: "/tire-network-react/repairs" },
    { text: "Tires", link: "/tire-network-react/tires" },
    { text: "Guarantees", link: "/tire-network-react/guarantees" },
  ];
  const aboutArr = [
    { text: "Our Team", link: "/tire-network-react/team" },
    { text: "Our Story", link: "/tire-network-react/story" },
    { text: "FAQ's", link: "/tire-network-react/faq-page" },
    { text: "Meet The Owner", link: "/tire-network-react/owner" },
  ];
  const contactArr = [
    { text: "Contact Us", link: "/tire-network-react/contact-us" },
    { text: "Location", link: "/tire-network-react/location" },
    { text: "Careers", link: "/tire-network-react/careers" },
  ];
  ...
  const [mobileSidebarMainItemClicked, setMobileSidebarMainItemClicked] =
    useState(null);

  const [mediumSidebarMainItemClicked, setMediumSidebarMainItemClicked] =
    useState(null);
  ...
  const handleMobileItemClicked = (itemId) => {
    setMobileSidebarMainItemClicked(
      mobileSidebarMainItemClicked === itemId ? null : itemId
    );
  };

  const handleMediumItemClicked = (itemId) => {
    setMediumSidebarMainItemClicked(
      mediumSidebarMainItemClicked === itemId ? null : itemId
    );
  };
    ...
    <>
      <div className="navbar-wide-screen-container">
          ...
          <div className="navbar-top-info-container">
            ...
            <div className="hours-container">
              <ul className="hours-list">
                ...
                <div
                  className="hours-list-main"
                  onMouseEnter={handleHoursHoverOn}
                ...
                >
                  <ul
                    className="show-hours-container"
                    onMouseEnter={handleHoursHoverOn}
                    onMouseLeave={handleHoursHoverOff}
                  >
                    {hours.map((hour, id) => {
                      return (
                        <li key={id} className="hour-items">
                          {hour.day} : {hour.hours}
                        </li>
                      );
                    })}
        ...
        <nav className="navbar-wide-screen-bottom">
          ...
          <Link className="appointment-link" to={"/tire-network-react/appointments"}>
            <div className="nav-item-content">
              <h3 className="color-heading">Appointments</h3>
            </div>
          </Link>
          <div className="nav-item-content">
            <div className="follow-us-content">
              ...
              <div>
                <a href="https://www.google.com/localservices/prolist?g2lbs=AIQllVwENXMKjBxqfoSM8trVe7jF9c4KmjOF3DkorWv9-f_X1XQEBFI1hw5xdLO-YWMY_WNn7xvw-87bHe5_b5OP4NEtMw-TqOCJEHLSpwfa1Eqa0w-BelODgvSk0kkPibx62Vi8W1aCs_q0um2k0hw3fCzBy56O7g%3D%3D&hl=en-US&gl=us&ssta=1&oq=auto%20shops%20in%20md&src=2&serdesk=1&sa=X&scp=CgASABoAKgA%3D&spp=QiUweDg5YzgwMzY4NjQ3ZGFmMzc6MHgyOTlmZjg1MmRlZjNmOGJl&slp=MgBAAVIvCAESKRInCiUweDg5YzgwMzY4NjQ3ZGFmMzc6MHgyOTlmZjg1MmRlZjNmOGJlIACaAQYKAhcZEAA%3D&q=the%20tire%20network%201024%20S%20Hanover%20St&ved=0CAAQ0swJahgKEwiQrJjUnfqDAxUAAAAAHQAAAAAQkQE#ts=1">
                  <img src="images/Google-g-icon.png" alt="" />
                </a>

                <a href="https://www.facebook.com/joe.hooe.5/">
        ...
        >
          <nav className="medium-sidebar">
            ...
            <div className="sidebar-main-container">
              <div
                className="our-shop-main-container"
                onClick={() => handleMediumItemClicked("ourShop")}
              >
                <h2>
                  Our Shop{" "}
                  {mediumSidebarMainItemClicked === "ourShop" ? "-" : "+"}
                </h2>
                <CSSTransition
                    ...
                    {ourShopArr.map((item, id) => {
                      return (
                        <Link
                          to={item.link}
                          key={id}
                          className="sidebar-sub-item-link"
                        >
                          <li
                            key={id}
                            onClick={toggleMediumNav}
              ...
              <div
                ...
                onClick={() => handleMediumItemClicked("services")}
              >
                <h2>
                  Services{" "}
                  {mediumSidebarMainItemClicked === "services" ? "-" : "+"}
                </h2>
                <CSSTransition
              ...
              <div
                ...
                onClick={() => handleMediumItemClicked("about")}
              >
                <h2>
                  About Us{" "}
                  {mediumSidebarMainItemClicked === "about" ? "-" : "+"}
                </h2>
                <CSSTransition
              ...
              <div
                ...
                onClick={() => handleMediumItemClicked("contact")}
              >
                <h2>
                  Contact Us{" "}
                  {mediumSidebarMainItemClicked === "contact" ? "-" : "+"}
                </h2>
                <CSSTransition
              ...
              <div className="appointments-main-container">
                <Link to={"/appointments"} className="appointments-item-link">
                  <h2 onClick={toggleMediumNav} className="appointments-item">
                    Appointments
                  </h2>
                </Link>
              </div>
        ...
        >
          <nav className="mobile-sidebar">
            ...
            <div className="sidebar-main-container">
              <div
                className="our-shop-main-container"
                onClick={() => handleMobileItemClicked("ourShop")}
              >
                <h2>
                  Our Shop{" "}
                  {mobileSidebarMainItemClicked === "ourShop" ? "-" : "+"}
                </h2>
                <CSSTransition
              ...
              <div
                className="services-main-container"
                onClick={() => handleMobileItemClicked("services")}
              >
                <h2>
                  Services{" "}
                  {mobileSidebarMainItemClicked === "services" ? "-" : "+"}
                </h2>
                <CSSTransition
              ...
              <div
                className="about-main-container"
                onClick={() => handleMobileItemClicked("about")}
              >
                <h2>
                  About Us{" "}
                  {mobileSidebarMainItemClicked === "about" ? "-" : "+"}
                </h2>
                <CSSTransition
              ...
              <div
                className="contact-main-container"
                onClick={() => handleMobileItemClicked("contact")}
              >
                <h2>
                  Contact Us{" "}
                  {mobileSidebarMainItemClicked === "contact" ? "-" : "+"}
                </h2>
                <CSSTransition
              ...
              <div className="appointments-main-container">
                <Link to="/appointments" className="appointments-item-link">
                  <h2 onClick={toggleMobileNav} className="appointments-item">
                    Appointments
                  </h2>
                </Link>
              </div>
